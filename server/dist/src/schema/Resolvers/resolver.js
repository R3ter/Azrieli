...
const createSub_1 = __importDefault(require("./mutation/createSub"));
const login_1 = __importDefault(require("./mutation/login"));
const removeSub_1 = __importDefault(require("./mutation/removeSub"));
...
exports.default = {
    ...
    Mutation: {
        removeSub: removeSub_1.default,
        createSub: createSub_1.default,
